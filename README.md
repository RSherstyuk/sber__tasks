*Разработка велась при пмощи GitHub Flow, все ветки идет с названием feature и были спушены при изменении, на любой коммит можно перейти и отследдить кажждое*
