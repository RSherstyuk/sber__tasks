*Разработка велась при пмощи GitHub Flow, все ветки идут с названием feature и были спушены при завершении, на любой коммит можно перейти и отследдить кажждое изменение*

### 1. Синхронизируем все зависимости проекта при помощи uv
```bash
uv sync
```
### 2. Структура проекта 
...
### в Models решения 1, 2 и 3 соответственно названия файлов
